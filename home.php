...
<!-- Info boxes -->
 <div class="col-12">
  ...
  <?php 
    ...
    $where = " WHERE addby = '{$_SESSION['login_id']}' ";
}
        ...
        <div class="col-md-4">
		  ...
		  <!--------#################################-------------------------------------->
		  <?phpif($_SESSION['login_type'] == 2 && $_SESSION['login_type'] == 1);?>
		   <div class="col-12 col-sm-6 col-md-12">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                <!--h3><?php echo $conn->query("SELECT t.*,p.name as pname,p.start_date,p.status as pstatus, p.end_date,p.id as pid FROM task_list t inner join project_list p on p.id = t.project_id $where2")->num_rows; ?></h3--->
				<!--h3><?php echo $conn->query("user_ids from project_list WHERE manager_id = '".$_SESSION['login_id']."'") ; ?>  </h3-->
