...
?----->
 ...
 <div class="col-sm-12 col-xl">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Apply For Resignation</h6>
							...
							<div class="form-floating mb-3">
    <textarea name="reason" class="form-control" rows="4" id="floatingPassword" placeholder="Comment"></textarea>
    <label for="floatingPassword">Reason</label>
              	...
              	<?php endwhile; ?>
							...
							<button = "submit" class = "btn btn-primary m-3" type = "submit" name = "resign">Apply</button>
							</form>
